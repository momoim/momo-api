                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="request-helper-oauth1-consumerKey"
                               ...
                               key="oauth_consumer_key" value="<?php echo WB_AKEY ?>"/>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="request-helper-oauth1-consumerSecret" class="clean-input"
                               key="oauth_consumer_secret" value="<?php echo WB_SKEY ?>"/>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="request-helper-oauth1-token" class="clean-input signatureParam"
                               key="oauth_token" value="<?php echo isset($_SESSION['last_key']['oauth_token']) ? $_SESSION['last_key']['oauth_token'] : ''; ?>"/>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="request-helper-oauth1-tokenSecret" class="clean-input"
                               key="oauth_token_secret" value="<?php echo isset($_SESSION['last_key']['oauth_token_secret']) ? $_SESSION['last_key']['oauth_token_secret'] : ''; ?>"/>
                    </div>
                </div>
                <div class="control-group">
    ...
    <div class="clearfix">
        ...
        <div id="body-editor-mode-selector">
            <div class="btn-group">
                ...
                <button class="btn" type="button" id="body-editor-mode-selector-format" tabindex="5">
                  Format code
                </button>
            </div>
        </div>
...
<div id="modal-edit-collection" class="modal fade">
    <div class="modal-header">
        <a class="close" data-dismiss="modal">×</a>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input">
                        ...
                        <input type="text" class="medium clean-input collection-request-name"/>
                    </div>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input">
                        <textarea class="medium collection-request-description"></textarea>
                    </div>
                </div>
            </div>
        </form>
