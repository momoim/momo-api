...
define('YOURLS_DB_USER', $config['default']['connection']['user']);

/** MySQL database password */
define('YOURLS_DB_PASS', $config['default']['connection']['pass']);

/** The name of the database for YOURLS */
define('YOURLS_DB_NAME', $config['default']['connection']['database']);

/** MySQL hostname */
define('YOURLS_DB_HOST', $config['default']['connection']['host']);

/** MySQL tables prefix */
define('YOURLS_DB_PREFIX', 'yourls');
...
define('YOURLS_COOKIEKEY', 'qQ4chinaKhL_pu|!s@Zm7n#%:b^{A[vhme');
