...
class Input_Core {
	 ...
	 * @return  string
	 */
	public function clean_input_data($str,$standardize=true)
	{
		if (is_array($str))
		{
			$new_array = array();
			...
			{
				// Recursion!
				$new_array[$this->clean_input_keys($key)] = $this->clean_input_data($val,$standardize);
			}
			return $new_array;
		}
		...
		if ($standardize===true && strpos($str, "\r") !== FALSE)
		{
