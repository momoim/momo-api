...
class user_agent_Core
{
    ...
    protected static $browserIdToName;

    protected static $browserIdToShortName;

    protected static $operatingSystemsIdToName;

    protected static $operatingSystemsIdToShortName;
    ...
    static protected function init()
    {
        ...
        self::$operatingSystemsIdToShortName = array_merge( 
            self::$operatingSystemsIdToName, 
            array (
                'PS3' => 'PS3', 
                'PSP' => 'PSP', 
                'IPH' => 'iPhone', 
