...
class url_Core {
	...
	/**
	 * Fetches an absolute image URL based on a URI segment.
	 *
	 * @return  string
	 */	
	public static function img_url()
	{
		return url::base().'images/';
	}

	/**
	 * Fetches an absolute css URL based on a URI segment.
	 *
	 * @return  string
	 */	
	...
	/**
	 * Fetches an absolute javascript URL based on a URI segment.
	 *
	 * @return  string
	 */	
