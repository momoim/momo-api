...
$album_image = file_exists($album_image) ? $album_image : DOCROOT . $album_image;
$album_tmp = file_exists($album_tmp) ? $album_tmp : DOCROOT . $album_tmp;
...
define('ALBUM_IMAGE', str_replace('\\', '/', realpath($album_image)) . '/');
define('ALBUM_TEMP', str_replace('\\', '/', realpath($album_tmp)) . '/');
